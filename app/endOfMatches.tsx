...
export default function EndOfMatches() {
    ...
    return(
        <SafeAreaView style={[{backgroundColor: colors.background[100], overflow: "hidden", height: "100%"}, modalOpen && { opacity: 0.1 }]}>
            ...
            <CustomModal setModalVisible={setModalOpen} modalVisible={modalOpen}>
                <>
                    ...
                    <View style={{ gap: 40 }}>
                        <Button text={"Play one more round"} onPress={handlePlayerOneMoreRound} />
