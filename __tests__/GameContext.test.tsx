...
jest.mock('@/data/categories.json', () => ({
  testCategory: {
    ...
    questions: {
      low: ['Low Q1?', 'Low Q2?', 'Low Q3?', 'Low Q4?', 'Low Q5?', 'Low Q6?', 'Low Q7?', 'Low Q8?'],
      medium: ['Med Q1?', 'Med Q2?', 'Med Q3?', 'Med Q4?', 'Med Q5?', 'Med Q6?', 'Med Q7?', 'Med Q8?'],
      high: ['High Q1?', 'High Q2?', 'High Q3?', 'High Q4?', 'High Q5?', 'High Q6?', 'High Q7?', 'High Q8?'],
    },
  },
  anotherCategory: {
